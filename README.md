...
1. Explain the difference between `RDBMS` and `SQL`.
      Relational Data Base Management system is the system on which we use the SQL Language to query data and generate new tables to return based on the relations between the Tables in the db

1. Why do tables need a `primary key`?
    Mainly to prevent duplicates, and prevent collision errors when retrieving data

1. What is the name given to a table column that references the primary key on another table.
    Foriegn Key
1. What do we need in order to have a _many to many_ relationship between two tables.
    Have a table of 2 or more foriegn key references.
## Project Set Up
